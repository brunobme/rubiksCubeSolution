...
public class R{ 
    public static void movimento(){
        ...
        CuboAtual.quinas[0][1] = CuboAtual.quinas[0][2];
        CuboAtual.quinas[0][2] = CuboAtual.quinas[0][6];
        ...
        if(CuboAtual.meios[0][1] == 1 || CuboAtual.meios[0][1] == 3 || CuboAtual.meios[0][1] == 9 || 
                ...
                CuboAtual.meios[1][5] = CuboAtual.meios[1][1];
        }else{
        ...
        if(CuboAtual.meios[0][6] == 1 || CuboAtual.meios[0][6] == 3 || CuboAtual.meios[0][6] == 9 || 
                ...
                CuboAtual.meios[1][1] = CuboAtual.meios[1][6];
        }else{
        ...
        if(CuboAtual.meios[0][9] == 1 || CuboAtual.meios[0][9] == 3 || CuboAtual.meios[0][9] == 9 || 
                ...
                CuboAtual.meios[1][6] = CuboAtual.meios[1][9];
        }else{
        ...
        CuboAtual.meios[0][1] = CuboAtual.meios[0][6];
        CuboAtual.meios[0][6] = CuboAtual.meios[0][9];
        CuboAtual.meios[0][9] = CuboAtual.meios[0][5];
