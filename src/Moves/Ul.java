...
public class Ul{
    public static void movimento(){
        ...
        CuboAtual.quinas[0][0] = CuboAtual.quinas[0][4];
        CuboAtual.quinas[0][4] = CuboAtual.quinas[0][5];
        CuboAtual.quinas[0][5] = CuboAtual.quinas[0][1];
        CuboAtual.quinas[0][1] = quina_temporaria;

        //atualizando orientação das quinas
        quina_temporaria = CuboAtual.quinas[1][0];
        CuboAtual.quinas[1][0] = CuboAtual.quinas[1][4];
        CuboAtual.quinas[1][4] = CuboAtual.quinas[1][5];
        CuboAtual.quinas[1][5] = CuboAtual.quinas[1][1];
        CuboAtual.quinas[1][1] = quina_temporaria;
        ...
        if(CuboAtual.meios[0][4] != 1 && CuboAtual.meios[0][4] != 3 && CuboAtual.meios[0][4] != 9 && 
                ...
                CuboAtual.meios[1][0] = CuboAtual.meios[1][4];
        }else{
        ...
        if(CuboAtual.meios[0][8] != 1 && CuboAtual.meios[0][8] != 3 && CuboAtual.meios[0][8] != 9 && 
                ...
                CuboAtual.meios[1][4] = CuboAtual.meios[1][8];
        }else{
        ...
        if(CuboAtual.meios[0][5] != 1 && CuboAtual.meios[0][5] != 3 && CuboAtual.meios[0][5] != 9 && 
                ...
                CuboAtual.meios[1][8] = CuboAtual.meios[1][5];
        }else{
        ...
        if(CuboAtual.meios[0][0] != 1 && CuboAtual.meios[0][0] != 3 && CuboAtual.meios[0][0] != 9 && 
                ...
                CuboAtual.meios[1][5] = meio_temporario;
        }else{
        ...
        CuboAtual.meios[0][0] = CuboAtual.meios[0][4];
        CuboAtual.meios[0][4] = CuboAtual.meios[0][8];
        CuboAtual.meios[0][8] = CuboAtual.meios[0][5];
        CuboAtual.meios[0][5] = meio_temporario;
