...
public class Dl{
    public static void movimento(){
        ...
        CuboAtual.quinas[0][3] = CuboAtual.quinas[0][2];
        CuboAtual.quinas[0][2] = CuboAtual.quinas[0][6];
        CuboAtual.quinas[0][6] = CuboAtual.quinas[0][7];
        ...
        CuboAtual.meios[0][2] = CuboAtual.meios[0][6];
        CuboAtual.meios[0][6] = CuboAtual.meios[0][10];
        CuboAtual.meios[0][10] = CuboAtual.meios[0][7];
