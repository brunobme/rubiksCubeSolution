...
public class L{
    public static void movimento(){
        ...
        CuboAtual.quinas[0][4] = CuboAtual.quinas[0][7];
        CuboAtual.quinas[0][7] = CuboAtual.quinas[0][3];
        CuboAtual.quinas[0][3] = quina_temporaria;
        ...
        if(CuboAtual.meios[0][4] == 1 || CuboAtual.meios[0][4] == 3 || CuboAtual.meios[0][4] == 9 || 
                ...
                CuboAtual.meios[1][3] = CuboAtual.meios[1][4];
        }else{
        ...
        if(CuboAtual.meios[0][11] == 1 || CuboAtual.meios[0][11] == 3 || CuboAtual.meios[0][11] == 9 || 
                ...
                CuboAtual.meios[1][4] = CuboAtual.meios[1][11];
        }else{
        ...
        if(CuboAtual.meios[0][7] == 1 || CuboAtual.meios[0][7] == 3 || CuboAtual.meios[0][7] == 9 || 
                ...
                CuboAtual.meios[1][11] = CuboAtual.meios[1][7];
        }else{
        ...
        CuboAtual.meios[0][3] = CuboAtual.meios[0][4];
        CuboAtual.meios[0][4] = CuboAtual.meios[0][11];
        CuboAtual.meios[0][11] = CuboAtual.meios[0][7];
